...
import { DataTablePagination } from '@/features/settings/service-charges/components/data-table-pagination'
import { DataTableToolbar } from '@/features/settings/service-charges/components/data-table-toolbar'

interface ServiceChargeDataTableProps {
  columns: ColumnDef<ServiceCharge>[]
  data: ServiceCharge[]
  pageCount: number
