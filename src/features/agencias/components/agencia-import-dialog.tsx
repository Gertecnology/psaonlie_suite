...
export function AgenciaImportDialog({ open, onOpenChange }: Props) {
    ...
    >
      <DialogContent className='gap-2 sm:max-w-sm'>
        <DialogHeader className='text-left'>
          ...
          <DialogDescription>
            Importa empresas rápidamente desde un archivo CSV.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form id='agencia-import-form' onSubmit={form.handleSubmit(onSubmit)}>
            <FormField
        ...
        <DialogFooter className='gap-2'>
          ...
          <Button type='submit' form='agencia-import-form'>
            Importar
          </Button>
        </DialogFooter>
      </DialogContent>
