...
import { obtenerParadasHomologadas } from '../services/agencia.service'
...
interface AgenciaParadasTableProps {
  agenciaId: string
}

export function AgenciaParadasTable({ agenciaId }: AgenciaParadasTableProps) {
  ...
  const { data, isLoading, error } = useQuery({
    queryKey: ['agencia-paradas', agenciaId, page, limit, searchTerm, sortBy],
    queryFn: () => obtenerParadasHomologadas(agenciaId, page, limit),
